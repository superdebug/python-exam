...
d1=datetime.timedelta(days=1000) #1000天日期
d2=datetime.timedelta(hours=1000)

(a-d1).isoformat()  #1000天以前
(a+d1).strftime('%m/%d/%Y') #1000天以后
b.isoformat()
(b-d2)

# 2. 离你的重要纪念日还有多少天 
important_day=datetime.datetime.strptime('2008-06-18','%Y-%m-%d')  #strptime将字符串转换成日期
